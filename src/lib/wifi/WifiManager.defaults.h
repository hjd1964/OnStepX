...
#define STA2_PASSWORD           "password" //  "password", Wifi Station mode password
#endif

#ifndef STA2_DHCP_ENABLED
#define STA2_DHCP_ENABLED           false  //      false, true to use LAN DHCP addresses
#endif

#ifndef STA2_TARGET_IP_ADDR 
#define STA2_TARGET_IP_ADDR  {192,168,0,1} // ..,168,0,1}, IP Address to connect to (OnStep for example)
#endif

#ifndef STA2_IP_ADDR
#define STA2_IP_ADDR         {192,168,0,2} //  ..168,0,2}, Wifi Station IP Address
#endif

#ifndef STA2_GW_ADDR
#define STA2_GW_ADDR         {192,168,0,1} // ..,168,0,1}, Wifi Station GATEWAY Address
#endif

#ifndef STA2_SN_MASK
#define STA2_SN_MASK       {255,255,255,0} // ..55,255,0}, Wifi Station SUBNET Mask
#endif
...
#define STA3_PASSWORD           "password" //  "password", Wifi Station mode password
#endif

#ifndef STA3_DHCP_ENABLED
#define STA3_DHCP_ENABLED           false  //      false, true to use LAN DHCP addresses
#endif

#ifndef STA3_TARGET_IP_ADDR 
#define STA3_TARGET_IP_ADDR  {192,168,0,1} // ..,168,0,1}, IP Address to connect to (OnStep for example)
#endif

#ifndef STA3_IP_ADDR
#define STA3_IP_ADDR         {192,168,0,2} //  ..168,0,2}, Wifi Station IP Address
#endif

#ifndef STA3_GW_ADDR
#define STA3_GW_ADDR         {192,168,0,1} // ..,168,0,1}, Wifi Station GATEWAY Address
#endif

#ifndef STA3_SN_MASK
#define STA3_SN_MASK       {255,255,255,0} // ..55,255,0}, Wifi Station SUBNET Mask
#endif

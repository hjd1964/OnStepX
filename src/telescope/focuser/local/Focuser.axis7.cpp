...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_7(7, AXIS7_REVERSE, &DriverSettingsAxis7, AXIS7_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis7 = {AXIS7_DRIVER_MODEL, AXIS7_DRIVER_STATUS, AXIS7_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver7(7, &DriverPinsAxis7, &DriverSettingsAxis7, AXIS7_STEPS_PER_MICRON/AXIS7_COUNTS_PER_MICRON, AXIS7_DRIVER_MICROSTEPS, AXIS7_DRIVER_IRUN, AXIS7_DRIVER_DECAY, AXIS7_DRIVER_DECAY_GOTO);
    #elif AXIS7_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver7(7, &DriverPinsAxis7, &DriverSettingsAxis7, AXIS7_STEPS_PER_MICRON/AXIS7_COUNTS_PER_MICRON, AXIS7_DRIVER_MICROSTEPS, AXIS7_DRIVER_IRUN, AXIS7_DRIVER_DECAY, AXIS7_DRIVER_DECAY_GOTO);
    #elif AXIS7_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver7(7, &DriverSettingsAxis7, AXIS7_STEPS_PER_MICRON/AXIS7_COUNTS_PER_MICRON);
    #endif

    ServoMotor motor_7(7, AXIS7_REVERSE, ((ServoDriver*)&driver7), &filterAxis7, &encAxis7, AXIS7_ENCODER_ORIGIN, AXIS7_ENCODER_REVERSE == ON, &feedbackAxis7, &servoControlAxis7);
  ...
  const AxisSettings SettingsAxis7 = {AXIS7_COUNTS_PER_MICRON, {AXIS7_LIMIT_MIN*1000.0F, AXIS7_LIMIT_MAX*1000.0F}, AXIS7_BACKLASH_RATE};
  }

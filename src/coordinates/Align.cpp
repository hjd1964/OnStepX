...
void GeoAlign::modelRead() {
  ...
  if (AlignModelSize < sizeof(AlignModel)) { DL("ERR: GeoAlign::readModel(); AlignModelSize error NV subsystem writes disabled"); nv.readOnly(true); }
...
void GeoAlign::modelWrite() {
  if (AlignModelSize < sizeof(AlignModel)) { DL("ERR: GeoAlign::writeModel(); AlignModelSize error NV subsystem writes disabled"); nv.readOnly(true); }

...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_5(5, AXIS5_REVERSE, &DriverSettingsAxis5, AXIS5_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis5 = {AXIS5_DRIVER_MODEL, AXIS5_DRIVER_STATUS, AXIS5_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver5(5, &DriverPinsAxis5, &DriverSettingsAxis5, AXIS5_STEPS_PER_MICRON/AXIS5_COUNTS_PER_MICRON, AXIS5_DRIVER_MICROSTEPS, AXIS5_DRIVER_IRUN, AXIS5_DRIVER_DECAY, AXIS5_DRIVER_DECAY_GOTO);
    #elif AXIS5_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver5(5, &DriverPinsAxis5, &DriverSettingsAxis5, AXIS5_STEPS_PER_MICRON/AXIS5_COUNTS_PER_MICRON, AXIS5_DRIVER_MICROSTEPS, AXIS5_DRIVER_IRUN, AXIS5_DRIVER_DECAY, AXIS5_DRIVER_DECAY_GOTO);
    #elif AXIS5_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver5(5, &DriverSettingsAxis5, AXIS5_STEPS_PER_MICRON/AXIS5_COUNTS_PER_MICRON);
    #endif
  ...
  const AxisSettings SettingsAxis5 = {AXIS5_COUNTS_PER_MICRON, {AXIS5_LIMIT_MIN*1000.0F, AXIS5_LIMIT_MAX*1000.0F}, AXIS5_BACKLASH_RATE};
  }

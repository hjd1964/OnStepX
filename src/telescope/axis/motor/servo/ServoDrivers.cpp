...
const ServoDriverPins ServoPins[] = {
    ...
    { 1, AXIS1_DCMOTOR_PH1_PIN, AXIS1_DCMOTOR_PH1_STATE, AXIS1_DCMOTOR_PH2_PIN, AXIS1_DCMOTOR_PH2_STATE, AXIS1_ENABLE_PIN, AXIS1_ENABLE_STATE, AXIS1_FAULT_PIN },
  #endif
  #ifdef AXIS2_DRIVER_SERVO
    { 2, AXIS2_DCMOTOR_PH1_PIN, AXIS2_DCMOTOR_PH1_STATE, AXIS2_DCMOTOR_PH2_PIN, AXIS2_DCMOTOR_PH2_STATE, AXIS2_ENABLE_PIN, AXIS2_ENABLE_STATE, AXIS2_FAULT_PIN },
  #endif
  #ifdef AXIS3_DRIVER_SERVO
    { 3, AXIS3_DCMOTOR_PH1_PIN, AXIS3_DCMOTOR_PH1_STATE, AXIS3_DCMOTOR_PH2_PIN, AXIS3_DCMOTOR_PH2_STATE, AXIS3_ENABLE_PIN, AXIS3_ENABLE_STATE, AXIS3_FAULT_PIN },
  #endif
  #ifdef AXIS4_DRIVER_SERVO
    { 4, AXIS4_DCMOTOR_PH1_PIN, AXIS4_DCMOTOR_PH1_STATE, AXIS4_DCMOTOR_PH2_PIN, AXIS4_DCMOTOR_PH2_STATE, AXIS4_ENABLE_PIN, AXIS4_ENABLE_STATE, AXIS4_FAULT_PIN },
  #endif
  #ifdef AXIS5_DRIVER_SERVO
    { 5, AXIS5_DCMOTOR_PH1_PIN, AXIS5_DCMOTOR_PH1_STATE, AXIS5_DCMOTOR_PH2_PIN, AXIS5_DCMOTOR_PH2_STATE, AXIS5_ENABLE_PIN, AXIS5_ENABLE_STATE, AXIS5_FAULT_PIN },
  #endif
  #ifdef AXIS6_DRIVER_SERVO
    { 6, AXIS6_DCMOTOR_PH1_PIN, AXIS6_DCMOTOR_PH1_STATE, AXIS6_DCMOTOR_PH2_PIN, AXIS6_DCMOTOR_PH2_STATE, AXIS6_ENABLE_PIN, AXIS6_ENABLE_STATE, AXIS6_FAULT_PIN },
  #endif
  #ifdef AXIS7_DRIVER_SERVO
    { 7, AXIS7_DCMOTOR_PH1_PIN, AXIS7_DCMOTOR_PH1_STATE, AXIS7_DCMOTOR_PH2_PIN, AXIS7_DCMOTOR_PH2_STATE, AXIS7_ENABLE_PIN, AXIS7_ENABLE_STATE, AXIS7_FAULT_PIN },
  #endif
  #ifdef AXIS8_DRIVER_SERVO
    { 8, AXIS8_DCMOTOR_PH1_PIN, AXIS8_DCMOTOR_PH1_STATE, AXIS8_DCMOTOR_PH2_PIN, AXIS8_DCMOTOR_PH2_STATE, AXIS8_ENABLE_PIN, AXIS8_ENABLE_STATE, AXIS8_FAULT_PIN },
  #endif
  #ifdef AXIS9_DRIVER_SERVO
    { 9, AXIS9_DCMOTOR_PH1_PIN, AXIS9_DCMOTOR_PH1_STATE, AXIS9_DCMOTOR_PH2_PIN, AXIS9_DCMOTOR_PH2_STATE, AXIS9_ENABLE_PIN, AXIS9_ENABLE_STATE, AXIS9_FAULT_PIN },
  #endif
};

...
#include "Mount.h"
  ...
  ServoControl servoControlAxis1;
    ...
    ServoTmc2209 driver1(1, &ServoPinsAxis1, &ServoSettingsAxis1, AXIS1_SERVO_TRACKING_VELOCITY/(AXIS1_STEPS_PER_DEGREE/240.0));
  #endif
...
Axis axis1(1, &PinsAxis1, &SettingsAxis1, AXIS_MEASURE_RADIANS, arcsecToRad(AXIS1_TARGET_TOLERANCE));
  ...
  ServoControl servoControlAxis2;
    ...
    ServoTmc2209 driver2(2, &ServoPinsAxis2, &ServoSettingsAxis2, AXIS2_SERVO_TRACKING_VELOCITY/(AXIS2_STEPS_PER_DEGREE/240.0));
  #endif

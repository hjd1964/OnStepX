...
#include "Rotator.h"
  ...
  ServoControl servoControlAxis3;
    ...
    const ServoTmcSettings ServoSettingsAxis3 = {AXIS3_DRIVER_MODEL, AXIS3_DRIVER_STATUS, AXIS3_SERVO_VELOCITY_MAX, AXIS3_SERVO_ACCELERATION, AXIS3_DRIVER_MICROSTEPS, AXIS3_DRIVER_IRUN, AXIS3_DRIVER_VELOCITY};

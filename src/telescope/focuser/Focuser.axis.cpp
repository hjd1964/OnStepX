...
#include "Focuser.h"
    ...
    ServoControl servoControlAxis4;
      ...
      Pid pidAxis4(AXIS4_SERVO_P, AXIS4_SERVO_I, AXIS4_SERVO_D, AXIS4_SERVO_P_GOTO, AXIS4_SERVO_I_GOTO, AXIS4_SERVO_D_GOTO, AXIS4_SERVO_VAR_PID_SENS);
    #endif
  ...
  Axis axis4(4, &PinsAxis4, &SettingsAxis4, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis5;
      ...
      Pid pidAxis5(AXIS5_SERVO_P, AXIS5_SERVO_I, AXIS5_SERVO_D, AXIS5_SERVO_P_GOTO, AXIS5_SERVO_I_GOTO, AXIS5_SERVO_D_GOTO, AXIS5_SERVO_VAR_PID_SENS);
    #endif
  ...
  Axis axis5(5, &PinsAxis5, &SettingsAxis5, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis6;
      ...
      Pid pidAxis6(AXIS6_SERVO_P, AXIS6_SERVO_I, AXIS6_SERVO_D, AXIS6_SERVO_P_GOTO, AXIS6_SERVO_I_GOTO, AXIS6_SERVO_D_GOTO, AXIS6_SERVO_VAR_PID_SENS);
    #endif
  ...
  Axis axis6(6, &PinsAxis6, &SettingsAxis6, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis7;
      ...
      Pid pidAxis7(AXIS7_SERVO_P, AXIS7_SERVO_I, AXIS7_SERVO_D, AXIS7_SERVO_P_GOTO, AXIS7_SERVO_I_GOTO, AXIS7_SERVO_D_GOTO, AXIS7_SERVO_VAR_PID_SENS);
    #endif
  ...
  Axis axis7(7, &PinsAxis7, &SettingsAxis7, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis8;
      ...
      Pid pidAxis8(AXIS8_SERVO_P, AXIS8_SERVO_I, AXIS8_SERVO_D, AXIS8_SERVO_P_GOTO, AXIS8_SERVO_I_GOTO, AXIS8_SERVO_D_GOTO, AXIS8_SERVO_VAR_PID_SENS);
    #endif
  ...
  Axis axis8(8, &PinsAxis8, &SettingsAxis8, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis9;
      ...
      Pid pidAxis9(AXIS9_SERVO_P, AXIS9_SERVO_I, AXIS9_SERVO_D, AXIS9_SERVO_P_GOTO, AXIS9_SERVO_I_GOTO, AXIS9_SERVO_D_GOTO, AXIS9_SERVO_VAR_PID_SENS);
    #endif

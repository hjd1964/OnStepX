...
#include "../../lib/sense/Sense.h"
  ...
  const AxisSettings Axis1Settings = {AXIS1_STEPS_PER_DEGREE*RAD_DEG_RATIO, AXIS1_DRIVER_REVERSE, AXIS1_DRIVER_MICROSTEPS, AXIS1_DRIVER_IRUN , { degToRadF(AXIS1_LIMIT_MIN), degToRadF(AXIS1_LIMIT_MAX) } };
  ...
  const AxisSettings Axis2Settings = {AXIS2_STEPS_PER_DEGREE*RAD_DEG_RATIO, AXIS2_DRIVER_REVERSE, AXIS2_DRIVER_MICROSTEPS, AXIS2_DRIVER_IRUN, { degToRadF(AXIS2_LIMIT_MIN), degToRadF(AXIS2_LIMIT_MAX) } };
...
void Axis::init(uint8_t axisNumber, bool alternateLimits, bool validKey) {
  ...
  if (axisNumber <= 3) { V(radToDegF(backlashFreq)); VL(" deg/sec."); } else { V(backlashFreq); VL(" microns/sec."); }

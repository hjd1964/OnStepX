...
namespace {
  ...
  const ServoSettings DriverSettingsAxis3 = {AXIS3_DRIVER_MODEL, AXIS3_DRIVER_STATUS, AXIS3_SERVO_ACCELERATION};
    ...
    ServoTmc2209 driver3(3, &DriverPinsAxis3, &DriverSettingsAxis3, AXIS3_STEPS_PER_DEGREE/AXIS3_COUNTS_PER_DEGREE, AXIS3_DRIVER_MICROSTEPS, AXIS3_DRIVER_IRUN, AXIS3_DRIVER_DECAY, AXIS3_DRIVER_DECAY_GOTO);
  #elif AXIS3_DRIVER_MODEL == SERVO_TMC5160
    ServoTmc5160 driver3(3, &DriverPinsAxis3, &DriverSettingsAxis3, AXIS3_STEPS_PER_DEGREE/AXIS3_COUNTS_PER_DEGREE, AXIS3_DRIVER_MICROSTEPS, AXIS3_DRIVER_IRUN, AXIS3_DRIVER_DECAY, AXIS3_DRIVER_DECAY_GOTO);
  #elif AXIS3_DRIVER_MODEL == SERVO_KTECH
    ServoKTech driver3(3, &DriverSettingsAxis3, AXIS3_STEPS_PER_DEGREE/AXIS3_COUNTS_PER_DEGREE);
  #endif
...
const AxisSettings SettingsAxis3 = {AXIS3_COUNTS_PER_DEGREE, {AXIS3_LIMIT_MIN, AXIS3_LIMIT_MAX}, AXIS3_BACKLASH_RATE};
}

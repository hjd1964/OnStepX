...
class StepDirTmc5161 : public TmcStepDirDriverSG {
  public:
    // constructor
    StepDirTmc5161(uint8_t axisNumber, const StepDirDriverPins *Pins, const StepDirDriverSettings *Settings, int16_t currentHold, int16_t currentRun, int16_t currentSlewing, int8_t intpol);

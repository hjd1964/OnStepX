...
#define AXIS3_ENCODER_A_PIN     AXIS3_STEP_PIN
#define AXIS3_ENCODER_B_PIN     AXIS3_DIR_PIN
...
#define AXIS4_ENCODER_A_PIN     AXIS3_STEP_PIN
#define AXIS4_ENCODER_B_PIN     AUX1_PIN

...
#include "Mount.h"
  ...
  ServoControl servoControlAxis1;
    ...
    const ServoTmcSettings ServoSettingsAxis1 = {AXIS1_DRIVER_MODEL, AXIS1_DRIVER_STATUS, AXIS1_SERVO_VELOCITY_MAX, AXIS1_SERVO_ACCELERATION, AXIS1_DRIVER_MICROSTEPS, AXIS1_DRIVER_IRUN};
    ServoTmc2209 driver1(1, &ServoPinsAxis1, &ServoSettingsAxis1);
  #elif defined(AXIS1_SERVO_TMC5160)
...
Axis axis1(1, &PinsAxis1, &SettingsAxis1, AXIS_MEASURE_RADIANS, arcsecToRad(AXIS1_TARGET_TOLERANCE));
  ...
  ServoControl servoControlAxis2;
    ...
    const ServoTmcSettings ServoSettingsAxis2 = {AXIS2_DRIVER_MODEL, AXIS2_DRIVER_STATUS, AXIS2_SERVO_VELOCITY_MAX, AXIS2_SERVO_ACCELERATION, AXIS2_DRIVER_MICROSTEPS, AXIS2_DRIVER_IRUN};
    ServoTmc2209 driver2(2, &ServoPinsAxis2, &ServoSettingsAxis2);
  #elif defined(AXIS2_SERVO_TMC5160)

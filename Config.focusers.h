...
#define AXIS4_DRIVER_POWER_DOWN       OFF //    OFF, ON Powers off 30sec after movement stops.                                Option
...
#define AXIS4_SLEW_RATE_MINIMUM        50 //     50, n. Where n=1..1000 (um/s.) Minimum microns/second.                       Adjust
#define AXIS4_SLEW_RATE_DESIRED       500 //    500, n, Where n=200..5000 (um/s.) Max microns/second.                         Adjust

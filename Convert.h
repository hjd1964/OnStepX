...
bool Convert::tzstrToDouble(double *f, char *hm) {
  int sign = 1;
  int hour;
  int minute = 0;
...
bool Convert::hmsToDouble(double *f, char *hms, PrecisionMode p) {
  char h[3], m[5];
  int  h1, m1, m2 = 0;
  double s1 = 0;
...
bool Convert::hmsToDouble(double *f, char *hms) {
...
bool Convert::dmsTodouble(double *f, char *dms, bool sign_present, PrecisionMode p) {
  char d[4], m[5];
...
bool Convert::dmsTodouble(double *f, char *dms, bool sign_present) {
...
void Convert::doubleToHms(char *reply, double f, PrecisionMode p) {
...
void Convert::doubleToDms(char *reply, double f, bool fullRange, bool signPresent, PrecisionMode p) {
  char sign[] = "+";
  int  o = 0;

...
void GeoAlign::modelRead() {
  ...
  if (AlignModelSize < sizeof(AlignModel)) { nv.initError = true; DL("ERR: GeoAlign::readModel(); AlignModelSize error NV subsystem writes disabled"); }
...
void GeoAlign::modelWrite() {
  if (AlignModelSize < sizeof(AlignModel)) { nv.initError = true; DL("ERR: GeoAlign::writeModel(); AlignModelSize error NV subsystem writes disabled"); }

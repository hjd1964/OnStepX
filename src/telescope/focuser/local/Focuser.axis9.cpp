...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_9(9, AXIS9_REVERSE, &DriverSettingsAxis9, AXIS9_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis9 = {AXIS9_DRIVER_MODEL, AXIS9_DRIVER_STATUS, AXIS9_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver9(9, &DriverPinsAxis9, &DriverSettingsAxis9, AXIS9_STEPS_PER_MICRON/AXIS9_COUNTS_PER_MICRON, AXIS9_DRIVER_MICROSTEPS, AXIS9_DRIVER_IRUN, AXIS9_DRIVER_DECAY, AXIS9_DRIVER_DECAY_GOTO);
    #elif AXIS9_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver9(9, &DriverPinsAxis9, &DriverSettingsAxis9, AXIS9_STEPS_PER_MICRON/AXIS9_COUNTS_PER_MICRON, AXIS9_DRIVER_MICROSTEPS, AXIS9_DRIVER_IRUN, AXIS9_DRIVER_DECAY, AXIS9_DRIVER_DECAY_GOTO);
    #elif AXIS9_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver9(9, &DriverSettingsAxis9, AXIS9_STEPS_PER_MICRON/AXIS9_COUNTS_PER_MICRON);
    #endif
  ...
  const AxisSettings SettingsAxis9 = {AXIS9_COUNTS_PER_MICRON, {AXIS9_LIMIT_MIN*1000.0F, AXIS9_LIMIT_MAX*1000.0F}, AXIS9_BACKLASH_RATE};
  }

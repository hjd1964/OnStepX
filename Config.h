...
#define PINMAP                  MksGenL2  //    OFF, Choose from: MiniPCB, MiniPCB2, MaxPCB2, MaxESP3, MaxSTM3,              <-Req'd
...
#define AXIS1_DRIVER_DECAY            OFF //    OFF, Decay mode for TMC drivers, often STEALTHCHOP is used here.              Option
#define AXIS1_DRIVER_DECAY_GOTO       OFF //    OFF, Decay mode for TMC drivers, often SPREADCYCLE is used here.              Option
...
#define AXIS2_DRIVER_DECAY            OFF //    OFF, Decay mode for TMC drivers, often STEALTHCHOP is used here.              Option
#define AXIS2_DRIVER_DECAY_GOTO       OFF //    OFF, Decay mode for TMC drivers, often SPREADCYCLE is used here.              Option
...
// AXIS6 FOCUSER 3
// see https://onstep.groups.io/g/main/wiki/6-Configuration#AXIS6
#define FOCUSER3                      OFF //    OFF, ON to enable this focuser.                                               Option
#define AXIS6_STEPS_PER_MICRON        0.5 //    0.5, n. Steps per micrometer. Figure this out by testing or other means.      Adjust
#define AXIS6_SLEW_RATE_DESIRED       500 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr %   Adjust

#define AXIS6_DRIVER_MODEL            OFF //    OFF, TMC2130, TMC5160. Leave OFF for all drivers models except these.         Option
#define AXIS6_DRIVER_MICROSTEPS       OFF //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
#define AXIS6_DRIVER_IHOLD            OFF //    OFF, n, (mA.) Current standstill. OFF uses IRUN/2.0.                  "       Option
#define AXIS6_DRIVER_IRUN             OFF //    OFF, n, (mA.) Current tracking, appropriate for stepper/driver/etc.   "       Option
#define AXIS6_DRIVER_POWER_DOWN       OFF //    OFF, ON Powers off the motor at stand-still.                                  Option
#define AXIS6_DRIVER_REVERSE          OFF //    OFF, ON Reverses movement direction, or reverse wiring instead to correct.    Option
#define AXIS6_DRIVER_DC_MODE          OFF //    OFF, DRV8825 for pwm dc motor control on stepper driver outputs.              Option

#define AXIS6_LIMIT_MIN_RATE           50 //     50, n. Where n=1..1000 (um/s.) Minimum microns/second. In DC mode, min pwr.  Adjust
...
#define FEATURE4_PURPOSE              PFF //    OFF, SWITCH, ANALOG_OUT, DEW_HEATER, INTERVALOMETER.                          Option

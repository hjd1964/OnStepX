...
#include "Rotator.h"
  ...
  ServoMotor motor3(3, &ServoPinsAxis3, &ServoSettingsAxis3, &encAxis3, &pidAxis3, &servoControlAxis3);
  void moveAxis3() { motor3.move(); }
#endif

#ifdef AXIS3_DRIVER_PRESENT
  const StepDirDriverPins StepDirPinsAxis3 = {AXIS3_STEP_PIN, AXIS3_STEP_STATE, AXIS3_DIR_PIN, AXIS3_ENABLE_PIN, AXIS3_ENABLE_STATE, AXIS3_M0_PIN, AXIS3_M1_PIN, AXIS3_M2_PIN, AXIS3_M2_ON_STATE, AXIS3_M3_PIN, AXIS3_DECAY_PIN, AXIS3_FAULT_PIN};
  const StepDirDriverSettings StepDirSettingsAxis3 = {AXIS3_DRIVER_MODEL, AXIS3_DRIVER_MICROSTEPS, AXIS3_DRIVER_MICROSTEPS_GOTO, AXIS3_DRIVER_IHOLD, AXIS3_DRIVER_IRUN, AXIS3_DRIVER_IGOTO, AXIS3_DRIVER_DECAY, AXIS3_DRIVER_DECAY_GOTO, AXIS3_DRIVER_STATUS};
  StepDirMotor motor3(3, &StepDirPinsAxis3, &StepDirSettingsAxis3);
#endif

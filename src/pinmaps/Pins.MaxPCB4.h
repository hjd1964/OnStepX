...
#define AXIS1_M3_PIN            34               // SPI MISO (UART RX)
...
#define AXIS2_M3_PIN            34               // SPI MISO (UART RX)
...
#define AXIS3_M3_PIN            34               // SPI MISO (UART RX)
...
#define AXIS4_M3_PIN            34               // SPI MISO (UART RX)
...
#define AXIS5_M3_PIN            34               // SPI MISO (UART RX)

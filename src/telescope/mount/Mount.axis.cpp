...
#include "Mount.h"
  ...
  const ServoSettings DriverSettingsAxis1 = {AXIS1_DRIVER_MODEL, AXIS1_DRIVER_STATUS, AXIS1_SERVO_VELOCITY_MAX_CPS, AXIS1_SERVO_ACCELERATION};

  #if AXIS1_DRIVER_MODEL == SERVO_EE
    ServoEE driver1(1, &DriverPinsAxis1, &DriverSettingsAxis1);
  #elif AXIS1_DRIVER_MODEL == SERVO_PE
    ServoPE driver1(1, &DriverPinsAxis1, &DriverSettingsAxis1);
  #elif AXIS1_DRIVER_MODEL == SERVO_TMC2130_DC
    ServoTmc5160DC driver1(1, &DriverPinsAxis1, &DriverSettingsAxis1);
  #elif AXIS1_DRIVER_MODEL == SERVO_TMC5160_DC
    ServoTmc2130DC driver1(1, &DriverPinsAxis1, &DriverSettingsAxis1);
...
Axis axis1(1, &PinsAxis1, &SettingsAxis1, AXIS_MEASURE_RADIANS, arcsecToRad(AXIS1_TARGET_TOLERANCE));
  ...
  const ServoSettings DriverSettingsAxis2 = {AXIS2_DRIVER_MODEL, AXIS2_DRIVER_STATUS, AXIS2_SERVO_VELOCITY_MAX_CPS, AXIS2_SERVO_ACCELERATION};

  #if AXIS2_DRIVER_MODEL == SERVO_EE
    ServoEE driver2(2, &DriverPinsAxis2, &DriverSettingsAxis2);
  #elif AXIS2_DRIVER_MODEL == SERVO_PE
    ServoPE driver2(2, &DriverPinsAxis2, &DriverSettingsAxis2);
  #elif AXIS2_DRIVER_MODEL == SERVO_TMC2130_DC
    ServoTmc2130DC driver2(2, &DriverPinsAxis2, &DriverSettingsAxis2);
  #elif AXIS2_DRIVER_MODEL == SERVO_TMC5160_DC
    ServoTmc5160DC driver2(2, &DriverPinsAxis2, &DriverSettingsAxis2);

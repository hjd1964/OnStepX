...
#define AXIS1_M3_PIN            19               // SPI MISO (UART RX)
...
#define AXIS2_M2_PIN            2                // SPI CS (UART TX)
#define AXIS2_M3_PIN            19               // SPI MISO (UART RX)
...
#define AXIS4_M2_PIN            14               // SPI CS (UART TX)

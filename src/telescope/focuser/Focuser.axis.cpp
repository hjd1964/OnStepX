...
#include "Focuser.h"
    ...
    ServoControl servoControlAxis4;
      ...
      const ServoDcSettings ServoSettingsAxis4 = {AXIS4_DRIVER_MODEL, AXIS4_DRIVER_STATUS, AXIS4_SERVO_MAX_VELOCITY, AXIS4_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis4 = {AXIS4_DRIVER_MODEL, AXIS4_DRIVER_STATUS, AXIS4_SERVO_MAX_VELOCITY, AXIS4_SERVO_ACCELERATION, AXIS4_DRIVER_MICROSTEPS, AXIS4_DRIVER_IRUN, AXIS4_DRIVER_VELOCITY};
  ...
  Axis axis4(4, &PinsAxis4, &SettingsAxis4, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis5;
      ...
      const ServoDcSettings ServoSettingsAxis5 = {AXIS5_DRIVER_MODEL, AXIS5_DRIVER_STATUS, AXIS5_SERVO_MAX_VELOCITY, AXIS5_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis5 = {AXIS5_DRIVER_MODEL, AXIS5_DRIVER_STATUS, AXIS5_SERVO_MAX_VELOCITY, AXIS5_SERVO_ACCELERATION, AXIS5_DRIVER_MICROSTEPS, AXIS5_DRIVER_IRUN, AXIS5_DRIVER_VELOCITY};
  ...
  Axis axis5(5, &PinsAxis5, &SettingsAxis5, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis6;
      ...
      const ServoDcSettings ServoSettingsAxis6 = {AXIS6_DRIVER_MODEL, AXIS6_DRIVER_STATUS, AXIS6_SERVO_MAX_VELOCITY, AXIS6_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis6 = {AXIS6_DRIVER_MODEL, AXIS6_DRIVER_STATUS, AXIS6_SERVO_MAX_VELOCITY, AXIS6_SERVO_ACCELERATION, AXIS6_DRIVER_MICROSTEPS, AXIS6_DRIVER_IRUN, AXIS6_DRIVER_VELOCITY};
  ...
  Axis axis6(6, &PinsAxis6, &SettingsAxis6, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis7;
      ...
      const ServoDcSettings ServoSettingsAxis7 = {AXIS7_DRIVER_MODEL, AXIS7_DRIVER_STATUS, AXIS7_SERVO_MAX_VELOCITY, AXIS7_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis7 = {AXIS7_DRIVER_MODEL, AXIS7_DRIVER_STATUS, AXIS7_SERVO_MAX_VELOCITY, AXIS7_SERVO_ACCELERATION, AXIS7_DRIVER_MICROSTEPS, AXIS7_DRIVER_IRUN, AXIS7_DRIVER_VELOCITY};
  ...
  Axis axis7(7, &PinsAxis7, &SettingsAxis7, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis8;
      ...
      const ServoDcSettings ServoSettingsAxis8 = {AXIS8_DRIVER_MODEL, AXIS8_DRIVER_STATUS, AXIS8_SERVO_MAX_VELOCITY, AXIS8_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis8 = {AXIS8_DRIVER_MODEL, AXIS8_DRIVER_STATUS, AXIS8_SERVO_MAX_VELOCITY, AXIS8_SERVO_ACCELERATION, AXIS8_DRIVER_MICROSTEPS, AXIS8_DRIVER_IRUN, AXIS8_DRIVER_VELOCITY};
  ...
  Axis axis8(8, &PinsAxis8, &SettingsAxis8, AXIS_MEASURE_MICRONS);
    ...
    ServoControl servoControlAxis9;
      ...
      const ServoDcSettings ServoSettingsAxis9 = {AXIS9_DRIVER_MODEL, AXIS9_DRIVER_STATUS, AXIS9_SERVO_MAX_VELOCITY, AXIS9_SERVO_ACCELERATION};
      ...
      const ServoTmcSettings ServoSettingsAxis9 = {AXIS9_DRIVER_MODEL, AXIS9_DRIVER_STATUS, AXIS9_SERVO_MAX_VELOCITY, AXIS9_SERVO_ACCELERATION, AXIS9_DRIVER_MICROSTEPS, AXIS9_DRIVER_IRUN, AXIS9_DRIVER_VELOCITY};

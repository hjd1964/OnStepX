...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_4(4, AXIS4_REVERSE, &DriverSettingsAxis4, AXIS4_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis4 = {AXIS4_DRIVER_MODEL, AXIS4_DRIVER_STATUS, AXIS4_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver4(4, &DriverPinsAxis4, &DriverSettingsAxis4, AXIS4_STEPS_PER_MICRON/AXIS4_COUNTS_PER_MICRON, AXIS4_DRIVER_MICROSTEPS, AXIS4_DRIVER_IRUN, AXIS4_DRIVER_DECAY, AXIS4_DRIVER_DECAY_GOTO);
    #elif AXIS4_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver4(4, &DriverPinsAxis4, &DriverSettingsAxis4, AXIS4_STEPS_PER_MICRON/AXIS4_COUNTS_PER_MICRON, AXIS4_DRIVER_MICROSTEPS, AXIS4_DRIVER_IRUN, AXIS4_DRIVER_DECAY, AXIS4_DRIVER_DECAY_GOTO);
    #elif AXIS4_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver4(4, &DriverSettingsAxis4, AXIS4_STEPS_PER_MICRON/AXIS4_COUNTS_PER_MICRON);
    #endif

    ServoMotor motor_4(4, AXIS4_REVERSE, ((ServoDriver*)&driver4), &filterAxis4, &encAxis4, AXIS4_ENCODER_ORIGIN, AXIS4_ENCODER_REVERSE == ON, &feedbackAxis4, &servoControlAxis4);
  ...
  const AxisSettings SettingsAxis4 = {AXIS4_COUNTS_PER_MICRON, {AXIS4_LIMIT_MIN*1000.0F, AXIS4_LIMIT_MAX*1000.0F}, AXIS4_BACKLASH_RATE};
  }

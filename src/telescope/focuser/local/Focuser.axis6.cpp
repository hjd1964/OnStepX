...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_6(6, AXIS6_REVERSE, &DriverSettingsAxis6, AXIS6_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis6 = {AXIS6_DRIVER_MODEL, AXIS6_DRIVER_STATUS, AXIS6_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver6(6, &DriverPinsAxis6, &DriverSettingsAxis6, AXIS6_STEPS_PER_MICRON/AXIS6_COUNTS_PER_MICRON, AXIS6_DRIVER_MICROSTEPS, AXIS6_DRIVER_IRUN, AXIS6_DRIVER_DECAY, AXIS6_DRIVER_DECAY_GOTO);
    #elif AXIS6_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver6(6, &DriverPinsAxis6, &DriverSettingsAxis6, AXIS6_STEPS_PER_MICRON/AXIS6_COUNTS_PER_MICRON, AXIS6_DRIVER_MICROSTEPS, AXIS6_DRIVER_IRUN, AXIS6_DRIVER_DECAY, AXIS6_DRIVER_DECAY_GOTO);
    #elif AXIS6_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver6(6, &DriverSettingsAxis6, AXIS6_STEPS_PER_MICRON/AXIS6_COUNTS_PER_MICRON);
    #endif
  ...
  const AxisSettings SettingsAxis6 = {AXIS6_COUNTS_PER_MICRON, {AXIS6_LIMIT_MIN*1000.0F, AXIS6_LIMIT_MAX*1000.0F}, AXIS6_BACKLASH_RATE};
  }

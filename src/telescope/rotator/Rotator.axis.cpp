...
#include "Rotator.h"
  ...
  const ServoSettings DriverSettingsAxis3 = {AXIS3_DRIVER_MODEL, AXIS3_DRIVER_STATUS, AXIS3_SERVO_VELOCITY_MAX_CPS, AXIS3_SERVO_ACCELERATION};
  ...
  #elif AXIS3_DRIVER_MODEL == TMC2209

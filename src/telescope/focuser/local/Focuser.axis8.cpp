...
// for axes 4 to 9 by replacing all occurances of '@' with the axis number
  ...
  namespace {
    ...
    Mks42DMotor motor_8(8, AXIS8_REVERSE, &DriverSettingsAxis8, AXIS8_STEPS_PER_MICRON);
    ...
    const ServoSettings DriverSettingsAxis8 = {AXIS8_DRIVER_MODEL, AXIS8_DRIVER_STATUS, AXIS8_SERVO_ACCELERATION};
      ...
      ServoTmc2209 driver8(8, &DriverPinsAxis8, &DriverSettingsAxis8, AXIS8_STEPS_PER_MICRON/AXIS8_COUNTS_PER_MICRON, AXIS8_DRIVER_MICROSTEPS, AXIS8_DRIVER_IRUN, AXIS8_DRIVER_DECAY, AXIS8_DRIVER_DECAY_GOTO);
    #elif AXIS8_DRIVER_MODEL == SERVO_TMC5160
      ServoTmc5160 driver8(8, &DriverPinsAxis8, &DriverSettingsAxis8, AXIS8_STEPS_PER_MICRON/AXIS8_COUNTS_PER_MICRON, AXIS8_DRIVER_MICROSTEPS, AXIS8_DRIVER_IRUN, AXIS8_DRIVER_DECAY, AXIS8_DRIVER_DECAY_GOTO);
    #elif AXIS8_DRIVER_MODEL == SERVO_KTECH
      ServoKTech driver8(8, &DriverSettingsAxis8, AXIS8_STEPS_PER_MICRON/AXIS8_COUNTS_PER_MICRON);
    #endif

    ServoMotor motor_8(8, AXIS8_REVERSE, ((ServoDriver*)&driver8), &filterAxis8, &encAxis8, AXIS8_ENCODER_ORIGIN, AXIS8_ENCODER_REVERSE == ON, &feedbackAxis8, &servoControlAxis8);
  ...
  const AxisSettings SettingsAxis8 = {AXIS8_COUNTS_PER_MICRON, {AXIS8_LIMIT_MIN*1000.0F, AXIS8_LIMIT_MAX*1000.0F}, AXIS8_BACKLASH_RATE};
  }

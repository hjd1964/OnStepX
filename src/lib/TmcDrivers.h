...
class TmcDriver {
  public:
    ...
    bool mode(bool intpol, int decay_mode, byte micro_step_mode, int irun, int ihold) {
      ...
      // set stealthChop bit
      if (decay_mode == STEALTH_CHOP) data_out |= 0x00000004UL;
    ...
    bool set_CHOPCONF_toff(int v)         { if (v >= 2 && v <= 15)      { cc_toff         = v; return true; } return false; }
    bool set_CHOPCONF_hstart(int v)       { if (v >= 0 && v <= 7)       { cc_hstart       = v; return true; } return false; }
    bool set_CHOPCONF_hend(int v)         { if (v >= 0 && v <= 15)      { cc_hend         = v; return true; } return false; }
    bool set_CHOPCONF_rndtf(int v)        { if (v >= 0 && v <= 1)       { cc_rndtf        = v; return true; } return false; }
    bool set_CHOPCONF_tbl(int v)          { if (v >= 0 && v <= 3)       { cc_tbl          = v; return true; } return false; }
    bool set_CHOPCONF_vsense(int v)       { if (v >= 0 && v <= 1)       { cc_vsense       = v; return true; } return false; }
    bool set_CHOPCONF_vhighfs(int v)      { if (v >= 0 && v <= 1)       { cc_vhighfs      = v; return true; } return false; }
    bool set_CHOPCONF_vhighchm(int v)     { if (v >= 0 && v <= 1)       { cc_vhighchm     = v; return true; } return false; }
    bool set_CHOPCONF_intpol(int v)       { if (v >= 0 && v <= 1)       { cc_intpol       = v; return true; } return false; }
    // TMC5160 specific
    bool set_CHOPCONF_tpfd(int v)         { if (v >= 0 && v <= 15)      { cc_tpfd         = v; return true; } return false; }

    volatile uint32_t last_chop_config;

    bool set_TPOWERDOWN_value(int v)      { if (v >= 0 && v <= 255)     { tpd_value       = v; return true; } return false; }

    bool set_TPWMTHRS_value(long v)       { if (v >= 0 && v <= 1048575) { tpt_value       = v; return true; } return false; }

    bool set_THIGH_value(long v)          { if (v >= 0 && v <= 1048575) { thigh_value     = v; return true; } return false; }

    bool set_PWMCONF_PWM_GRAD(int v)      { if (v >= 0 && v <= 255)     { pc_pwm_grad     = v; return true; } return false; }
    bool set_PWMCONF_pwm_freq(int v)      { if (v >= 0 && v <= 3)       { pc_pwm_freq     = v; return true; } return false; }
    bool set_PWMCONF_pwm_auto(int v)      { if (v >= 0 && v <= 1)       { pc_pwm_auto     = v; return true; } return false; }
    bool set_PWMCONF_pwm_freewheel(int v) { if (v >= 0 && v <= 1)       { pc_pwm_freewheel= v; return true; } return false; }
    // TMC2130 specific
    bool set_PWMCONF_PWM_AMPL(int v)      { if (v >= 0 && v <= 255)     { pc_pwm_ampl     = v; return true; } return false; }
    bool set_PWMCONF_pwm_sym(int v)       { if (v >= 0 && v <= 1)       { pc_pwm_sym      = v; return true; } return false; }
    // TMC5160/5161 specific
    bool set_PWMCONF_PWM_OFS(int v)       { if (v >= 0 && v <= 255)     { pc_PWM_OFS      = v; return true; } return false; }
    bool set_PWMCONF_pwm_autograd(int v)  { if (v >= 0 && v <= 1)       { pc_pwm_autograd = v; return true; } return false; }
    bool set_PWMCONF_PWM_REG(int v)       { if (v >= 0 && v <= 15)      { pc_pwm_reg      = v; return true; } return false; }
    bool set_PWMCONF_PWM_LIM(int v)       { if (v >= 0 && v <= 15)      { pc_PWM_LIM      = v; return true; } return false; }
    ...
    bool get_DRVSTATUS_stst()       { return ds_stst; }
    bool get_DRVSTATUS_olA()        { return ds_ola;  }
    bool get_DRVSTATUS_olB()        { return ds_olb;  }
    bool get_DRVSTATUS_s2gA()       { return ds_s2ga; }
    bool get_DRVSTATUS_s2gB()       { return ds_s2gb; }
    bool get_DRVSTATUS_otpw()       { return ds_otpw; }
    bool get_DRVSTATUS_ot()         { return ds_ot;   }
    bool get_DRVSTATUS_stallguard() { return ds_stallguard; }
    int  get_DRVSTATUS_cs_actual()  { return ds_cs_actual;  }
    bool get_DRVSTATUS_active()     { return ds_fs_active;  }
    int  get_DRVSTATUS_result()     { return ds_result;     }
    ...
    bool set_COOLCONF_semin(int v)  { if (v >= 0 && v <= 15)   { cl_semin = v; return true; } return false; }
    bool set_COOLCONF_seup(int v)   { if (v >= 0 && v <= 3)    { cl_seup  = v; return true; } return false; }
    bool set_COOLCONF_semax(int v)  { if (v >= 0 && v <= 15)   { cl_semax = v; return true; } return false; }
    bool set_COOLCONF_sedn(int v)   { if (v >= 0 && v <= 3)    { cl_sedn  = v; return true; } return false; }
    bool set_COOLCONF_seimin(int v) { if (v >= 0 && v <= 1)    { cl_seimin= v; return true; } return false; }
    bool set_COOLCONF_sgt(int v)    { if (v >= -64 && v <= 63) { cl_sgt= v+64; return true; } return false; }
    bool set_COOLCONF_sfilt(int v)  { if (v >= 0 && v <= 1)    { cl_sfilt = v; return true; } return false; }
